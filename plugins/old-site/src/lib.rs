...
const POLE: Color = Color { r: 0x55, g: 0x55, b: 0x55, a: 0xff };
const BOX: Color = Color { r: 0x2a, g: 0x2a, b: 0x32, a: 0xff };
const LIGHT: Color = Color { r: 0xff, g: 0xe0, b: 0x80, a: 0xff };
