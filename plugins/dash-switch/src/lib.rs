ruleste_plugins_api::ruleste_meta!("dashSwitch");
ruleste_plugins_api::ruleste_entity_types!("dashSwitchH", "dashSwitchV");
ruleste_plugins_api::ruleste_noop_destroy!();
ruleste_plugins_api::ruleste_noop_serialize!();

use ruleste_plugins_api::event;
use ruleste_plugins_api::host::{draw_rect, emit, entities_by_type};
